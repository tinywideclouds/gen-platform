...
const file_src_types_secure_v1_envelope_proto_rawDesc = "" +
	"\n" +
	"\"src/types/secure/v1/envelope.proto\x12\x1caction_intention.envelope.v1\"\xb2\x01\n" +
	...
	"\tsignature\x18\x04 \x01(\fR\tsignature\"d\n" +
	"\x14SecureEnvelopeListPb\x12L\n" +
	"\tenvelopes\x18\x01 \x03(\v2..action_intention.envelope.v1.SecureEnvelopePbR\tenvelopesB7Z5github.com/tinywideclouds/gen-platform/go/sm/v1;sm_v1b\x06proto3"
